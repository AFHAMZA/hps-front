...
import { ClientsComponent } from './pages/agent/clients/clients.component';
import { WhatsAppComponent } from './pages/agent/whatsApp/whatsapp.component';
import { SendMessageComponent } from './pages/agent/SendMessage/send-message.component';
import { GroupsComponent } from './pages/agent/groups/groups.component';
import { TokensComponent } from './pages/agent/token/token.component';
...
export const routes: Routes = [
  ...
  { path: 'list-layout-full', component: ListLayoutFullComponent },
  {
    ...
    component: GridLayoutWithSidebarComponent,
  },
  {
    path: 'classical-layout-with-sidebar',
    component: ClassicalLayoutWithSidebarComponent,
  },
  ...
  { path: 'classical-property', component: ClassicalPropertyComponent },
  {
    ...
    component: ClassicalLayoutWithMapComponent,
  },
  ...
  {
    path: 'submit-property-dashboard',
    component: SubmitPropertyDashboardComponent,
  },
];
